...
function FetchMyBox(){
  ...
  useEffect(() => {
    ...
    <div className="w-fit h-fit bg-none border border-[#84c8ff] p-4 flex flex-col gap-4 justify-center rounded-3xl ">
      ...
      <input type="text" name="" placeholder="Box Name" value={fieldBoxName.trimStart()} onChange={e => setFieldBoxName(e.target.value)} className="p-2" />

      <input type="password" name="" placeholder="Password" value={fieldBoxCode.trimStart().trimEnd()} onChange={e => setFieldBoxCode(e.target.value)}  className="p-2" />
